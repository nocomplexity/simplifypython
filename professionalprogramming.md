...
{octicon}`thumbsup;1em;caption-text` **Google Python Style Guide**
^^^
...
{octicon}`heart;1em;caption-text` **Python Enhancement Proposals**
^^^
...
{octicon}`smiley;1em;caption-text` **uv**
^^^
