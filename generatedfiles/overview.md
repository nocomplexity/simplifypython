...
{octicon}`thumbsup;1em;caption-text` **A Whirlwind Tour of Python**
^^^
...
{octicon}`telescope;1em;caption-text` **An Introduction to Programming using entity-component-systems & existence-based processing in python**
^^^
...
{octicon}`smiley;1em;caption-text` **Clean Architectures in Python**
^^^
...
{octicon}`stack;1em;caption-text` **From Python to Numpy**
^^^
...
{octicon}`tag;1em;caption-text` **Inside The Python Virtual Machine**
^^^
...
{octicon}`briefcase;1em;caption-text` **Learn Python with Jupyter**
^^^
...
{octicon}`verified;1em;caption-text` **Learning Data Science**
^^^
...
{octicon}`light-bulb;1em;caption-text` **Python Data Science Handbook**
^^^
...
{octicon}`thumbsup;1em;caption-text` **Python Programming for Data Science**
^^^
...
{octicon}`package;1em;caption-text` **Python Programming for Economics and Finance**
^^^
...
{octicon}`briefcase;1em;caption-text` **Python Security Handbook**
^^^
...
{octicon}`file;1em;caption-text` **Anaconda**
^^^
...
{octicon}`verified;1em;caption-text` **NumFOCUS**
^^^
...
:::{grid-item-card}
{octicon}`project;1em;caption-text` **Pangeo**
^^^
...
{octicon}`megaphone;1em;caption-text` **PyData**
^^^
...
{octicon}`report;1em;caption-text` **Python Documentation Community**
^^^
...
{octicon}`zap;1em;caption-text` **BDI 475**
^^^
...
{octicon}`heart;1em;caption-text` **Mastering Security Testing for Python**
^^^
...
{octicon}`cross-reference;1em;caption-text` **Scientific Python Lectures**
^^^
...
:::{grid-item-card}
{octicon}`package;1em;caption-text` **Foundations of Data Science with Python**
^^^
...
{octicon}`zap;1em;caption-text` **Official Python Community forums**
^^^
...
{octicon}`project;1em;caption-text` **Python Developers Community (moderated) Linkedin**
^^^
...
{octicon}`note;1em;caption-text` **r/Python**
^^^
...
:::{grid-item-card}
:link: https://numfocus.org/ 
{octicon}`eye;1em;caption-text` **NumFOCUS**
^^^
...
{octicon}`book;1em;caption-text` **Project Pythia**
^^^
...
:::{grid-item-card}
{octicon}`pencil;1em;caption-text` **WheelNext**
^^^
...
{octicon}`file;1em;caption-text` **movement**
^^^
...
:::{grid-item-card}
:link: https://www.pyopensci.org/python-package-guide/index.html 
{octicon}`verified;1em;caption-text` **pyOpenSci**
^^^
...
{octicon}`verified;1em;caption-text` **Lona**
^^^
...
{octicon}`tools;1em;caption-text` **Panel**
^^^
...
{octicon}`package;1em;caption-text` **Optiland**
^^^
...
{octicon}`report;1em;caption-text` **Black**
^^^
...
{octicon}`stack;1em;caption-text` **Green Tree Snakes - the missing Python AST docs**
^^^
...
{octicon}`zap;1em;caption-text` **Mamba’s documentation**
^^^
...
{octicon}`telescope;1em;caption-text` **Nox**
^^^
...
{octicon}`file;1em;caption-text` **PyPI User Documentation**
^^^
...
{octicon}`file;1em;caption-text` **Pydantic**
^^^
...
{octicon}`megaphone;1em;caption-text` **Pyodide**
^^^
...
{octicon}`megaphone;1em;caption-text` **Python Code Audit**
^^^
...
{octicon}`bookmark;1em;caption-text` **Official Python documentation**
^^^
...
{octicon}`bookmark;1em;caption-text` **Python Developer’s Guide**
^^^
...
{octicon}`pencil;1em;caption-text` **Python Enhancement Proposals (PEPs)**
^^^
...
{octicon}`check-circle;1em;caption-text` **The Python Language Reference**
^^^
...
{octicon}`report;1em;caption-text` **pip**
^^^
...
{octicon}`checklist;1em;caption-text` **Beautiful Soup**
^^^
...
:::{grid-item-card}
{octicon}`package;1em;caption-text` **msgspec**
^^^
...
{octicon}`telescope;1em;caption-text` **Cython**
^^^
...
```{image} https://github.com/RustPython/RustPython/blob/main/logo.png 
:height: 100px 
```
...
{octicon}`report;1em;caption-text` **Google Python Style Guide**
^^^
...
:::{grid-item-card}
:link: https://hatch.pypa.io/latest/ 
{octicon}`project;1em;caption-text` **Hatch**
^^^
Hatch is a modern, extensible Python project manager. 
+++
[Read more or use this reference »](https://hatch.pypa.io/latest/)
...
:::{grid-item-card}
:link: https://docs.pydantic.dev/latest/ 
{octicon}`note;1em;caption-text` **Pydantic**
^^^
Data validation using Python type hints.  Fast and extensible, Pydantic plays nicely with your linters/IDE/brain. Define how data should be in pure, canonical Python 3.9+; 
+++
[Read more or use this reference »](https://docs.pydantic.dev/latest/)
...
:::{grid-item-card}
:link: https://nocomplexity.com/codeaudit/ 
{octicon}`hubot;1em;caption-text` **Python Code Audit**
^^^
...
:::{grid-item-card}
:link: https://packaging.python.org/en/latest/ 
{octicon}`note;1em;caption-text` **Python Packaging User Guide**
^^^
A collection of tutorials and references to help you distribute and install Python packages with modern tools.
+++
[Read more or use this reference »](https://packaging.python.org/en/latest/)
...
{octicon}`briefcase;1em;caption-text` **mypy**
^^^
...
{octicon}`tools;1em;caption-text` **pipx**
^^^
...
:::{grid-item-card}
{octicon}`note;1em;caption-text` **Coding Patterns for Python Extensions**
^^^
...
{octicon}`megaphone;1em;caption-text` **Memray**
^^^
...
{octicon}`telescope;1em;caption-text` **PyTermGUI**
^^^
...
{octicon}`bookmark;1em;caption-text` **Reflex**
^^^
...
:::{grid-item-card}
:link: https://nox.thea.codes/en/stable/index.html 
{octicon}`hubot;1em;caption-text` **Nox**
^^^
nox is a command-line tool that automates testing in multiple Python environments, similar to tox. Unlike tox, Nox uses a standard Python file for configuration.
+++
[Read more or use this reference »](https://nox.thea.codes/en/stable/index.html)
...
{octicon}`check-circle;1em;caption-text` **pytest**
^^^
...
{octicon}`light-bulb;1em;caption-text` **Vizzu**
^^^
