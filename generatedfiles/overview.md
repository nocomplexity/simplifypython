...
{octicon}`bookmark;1em;caption-text` **urllib3**
^^^
...
{octicon}`thumbsup;1em;caption-text` **Green Tree Snakes - the missing Python AST docs**
^^^
...
{octicon}`telescope;1em;caption-text` **Setuptools**
^^^
...
{octicon}`light-bulb;1em;caption-text` **Static Typing with Python**
^^^
...
{octicon}`cross-reference;1em;caption-text` **PyPI Package Statistics & Analytics**
^^^
...
:::{grid-item-card}
:link: https://docs.pydantic.dev/latest/ 
{octicon}`package;1em;caption-text` **Pydantic**
^^^
Data validation using Python type hints.  Fast and extensible, Pydantic plays nicely with your linters/IDE/brain. Define how data should be in pure, canonical Python 3.9+; 
+++
[Read more or use this reference »](https://docs.pydantic.dev/latest/)
...
{octicon}`book;1em;caption-text` **mypy**
^^^
...
{octicon}`megaphone;1em;caption-text` **pandas docstring guide**
^^^
...
{octicon}`stack;1em;caption-text` **uv**
^^^
...
{octicon}`smiley;1em;caption-text` **Dear PyGui**
^^^
...
{octicon}`light-bulb;1em;caption-text` **Mesop**
^^^
...
{octicon}`briefcase;1em;caption-text` **PyTermGUI**
^^^
...
{octicon}`briefcase;1em;caption-text` **Rich**
^^^
...
{octicon}`checklist;1em;caption-text` **pytest**
^^^
...
{octicon}`bookmark;1em;caption-text` **Matplotlib**
^^^
...
{octicon}`telescope;1em;caption-text` **Vega-Altair**
^^^
