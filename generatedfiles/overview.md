...
{octicon}`stack;1em;caption-text` **Python Programming for Data Science**
^^^
...
{octicon}`cross-reference;1em;caption-text` **Python for Data Analysis, 3E**
^^^
...
{octicon}`report;1em;caption-text` **Python Packages**
^^^
...
{octicon}`file;1em;caption-text` **From Python to Numpy**
^^^
...
{octicon}`check-circle;1em;caption-text` **Jazzband**
^^^
...
{octicon}`briefcase;1em;caption-text` **PyData**
^^^
...
{octicon}`light-bulb;1em;caption-text` **The Scientific Python project**
^^^
...
{octicon}`heart;1em;caption-text` **NumFOCUS**
^^^
...
:::{grid-item-card}
:link: https://www.pyopensci.org/python-package-guide/index.html 
{octicon}`pencil;1em;caption-text` **pyOpenSci**
^^^
...
{octicon}`eye;1em;caption-text` **Mamba’s documentation**
^^^
...
{octicon}`bookmark;1em;caption-text` **The Python Language Reference**
^^^
...
{octicon}`tools;1em;caption-text` **Python Packaging User Guide**
^^^
...
{octicon}`cross-reference;1em;caption-text` **conda-forge**
^^^
...
{octicon}`file;1em;caption-text` **Beautiful Soup**
^^^
...
:::{grid-item-card}
:link: https://lxml.de/ 
{octicon}`tools;1em;caption-text` **lxml**
^^^
...
{octicon}`book;1em;caption-text` **PyPI Stats**
^^^
...
{octicon}`package;1em;caption-text` **mypy**
^^^
...
{octicon}`note;1em;caption-text` **Typer**
^^^
...
{octicon}`light-bulb;1em;caption-text` **Python Prompt Toolkit**
^^^
...
{octicon}`pencil;1em;caption-text` **Rich**
^^^
...
{octicon}`project;1em;caption-text` **Fire**
^^^
...
{octicon}`pencil;1em;caption-text` **Dear PyGui**
^^^
