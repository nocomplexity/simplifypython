...
{octicon}`heart;1em;caption-text` **Green Tree Snakes - the missing Python AST docs**
^^^
...
{octicon}`heart;1em;caption-text` **Hatch**
^^^
...
{octicon}`checklist;1em;caption-text` **Nox**
^^^
...
{octicon}`note;1em;caption-text` **PyPI User Documentation**
^^^
...
{octicon}`bookmark;1em;caption-text` **Pydantic**
^^^
...
{octicon}`check-circle;1em;caption-text` **Python Code Audit**
^^^
...
{octicon}`check-circle;1em;caption-text` **pex**
^^^
...
{octicon}`pencil;1em;caption-text` **PyPI Package Statistics & Analytics**
^^^
...
{octicon}`megaphone;1em;caption-text` **conda-forge**
^^^
...
{octicon}`tag;1em;caption-text` **Google Python Style Guide**
^^^
...
:::{grid-item-card}
:link: https://docs.pydantic.dev/latest/ 
{octicon}`tools;1em;caption-text` **Pydantic**
^^^
Data validation using Python type hints.  Fast and extensible, Pydantic plays nicely with your linters/IDE/brain. Define how data should be in pure, canonical Python 3.9+; 
+++
[Read more or use this reference »](https://docs.pydantic.dev/latest/)
...
:::{grid-item-card}
:link: https://nocomplexity.com/codeaudit/ 
{octicon}`heart;1em;caption-text` **Python Code Audit**
^^^
...
{octicon}`telescope;1em;caption-text` **pipx**
^^^
...
:::{grid-item-card}
:link: https://www.pyopensci.org/python-package-guide/index.html 
{octicon}`megaphone;1em;caption-text` **pyOpenSci Python Package Guide**
^^^
Learn how to create a Python package from start to finish. Also great tutorials for writing test, documentation and more!
+++
[Read more or use this reference »](https://www.pyopensci.org/python-package-guide/index.html)
...
{octicon}`project;1em;caption-text` **uv**
^^^
...
{octicon}`hubot;1em;caption-text` **Mesop**
^^^
...
{octicon}`report;1em;caption-text` **Rich**
^^^
...
{octicon}`note;1em;caption-text` **pytest**
^^^
...
{octicon}`light-bulb;1em;caption-text` **Matplotlib**
^^^
...
{octicon}`report;1em;caption-text` **Vizzu**
^^^
