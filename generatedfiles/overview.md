...
{octicon}`telescope;1em;caption-text` **The Python Language Reference**
^^^
...
{octicon}`zap;1em;caption-text` **Beautiful Soup**
^^^
...
{octicon}`cross-reference;1em;caption-text` **pytest**
^^^
